...
### Objetivo
O principal objetivo é praticar conceitos básicos da linguagem de forma clara e direta, facilitando o aprendizado de iniciantes.

### Nível
**Iniciante** — bem básico, apenas dando os primeiros passos no JavaScript.
